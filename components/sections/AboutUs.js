                        ...
                        <ul>
                            { misiData.map((misi, index) => 
                                <li key={ index }>
                                    ...
                                    <Typograph tag='p' color='green-20' size='sm-2'>{ misi }</Typograph>
                                </li>
                            ) }
                        </ul>
                    </div>
    ...
    const cultureData = [
        {
            ...
            number: (props) => (
                <svg className={ props.className } width="128" height="159" viewBox="0 0 70 159" fill="none">
        ...
        },
        {
            ...
            number: (props) => (
                <svg className={ props.className } width="128" height="161" viewBox="0 0 113 161" fill="none">
        ...
        },
        {
            ...
            number: (props) => (
                <svg className={ props.className } width="128" height="163" viewBox="0 0 112 163" fill="none">
