...
export async function getServerSideProps({ params }) {
    try {
        ...
        const tipsRes = await (await fetch(`https://compro-api.eratani.co.id/api/blogs/category/tips?limit=4&offset=0`)).json()
...
export default function BlogPage({ s_blogData, s_tipsData }) {
