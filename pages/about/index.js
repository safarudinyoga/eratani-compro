        ...
        data: [
            {
                ...
                numberVect: ({ className }) => (
                    <svg className={ className } width="128" height="159" viewBox="0 0 70 159" fill="none">
            ...
            },
            {
                ...
                numberVect: ({ className }) => (
                    <svg className={ className } width="128" height="161" viewBox="0 0 113 161" fill="none">
            ...
            },
            {
                ...
                numberVect: ({ className }) => (
                    <svg className={ className } width="128" height="163" viewBox="0 0 112 163" fill="none">
